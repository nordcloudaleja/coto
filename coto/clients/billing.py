...
class Client(BaseClient):
    ...
    * Tax Registrations:
    ...
    def _get_xsrf_token(self):
        r = self.session()._get(
            'https://cn-northwest-1.console.amazonaws.cn/billing/home?region=cn-northwest-1&state=hashArgs%23'
        )
    ...
    def _get(self, api):
        r = self.session()._get(
            "https://cn-northwest-1.console.amazonaws.cn/billing/rest/v1.0/{0}?state=hashArgs%23".
            format(api),
